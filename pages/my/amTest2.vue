...
<template>
    <div>
        ...
        <div class="moveTrack">
            <TransitionGroup name="move" tag="div" class="moveList">    
            <div v-for="item in items" class="moveItem" :key="item">
                {{ item }}
            </div>
            <div v-for="item in items" class="m2 moveItem" :key="item">
                {{ item }}
            </div>
